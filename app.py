...
"dan menjelaskan hasil prediksi menggunakan metode Explainable AI (SHAP)."
)
...
# SHAP Explanation
# =========================
st.subheader("Penjelasan Prediksi (Explainable AI)")
...
try:
    ...
    st.write(
    "Grafik di atas menunjukkan kontribusi masing-masing fitur terhadap hasil prediksi. "
    "Fitur berwarna merah meningkatkan tingkat stres, sedangkan biru menurunkan tingkat stres."
    )
